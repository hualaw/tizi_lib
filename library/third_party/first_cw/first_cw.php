...
class Spell {
    ...
    public function __construct($flag = true) {
        $this->flag = $flag;
        //加载资源
        $this->source['gk221'] = file_get_contents(self::DATA_PATH . '/word/gk2-2-1.txt');
        $this->source['gk31'] = file_get_contents(self::DATA_PATH . '/word/gk3-1.txt');
        $this->source['gk41'] = file_get_contents(self::DATA_PATH . '/word/gk4-1.txt');
        $this->pos = json_decode(file_get_contents(self::DATA_PATH . '/word/pos.txt'), true);
    }
