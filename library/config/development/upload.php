...
$config['oss_domain'] = 'oss.aliyuncs.com';		//如果web服务器在阿里云上请改为oss-internal.aliyuncs.com
...
$config['folder_avatar'] = 'avatar_dev/';
...
$config['space_folder_avatar'] = 'space_avatar_dev/';
...
$config['football_folder_avatar'] = 'huodong_football_avatar_dev/';
