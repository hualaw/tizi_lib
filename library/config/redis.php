...
$config['redis_db']['task']			= 22;//任务系统相关
...
$config['redis_slave']['host'] = '10.160.29.137';
$config['redis_slave']['port'] = '6379';
$config['redis_slave']['password'] = 't3)TKle[q8vk\|&JsM1%!yj{(2:G0-HN';        // Can be left empty when the server does not require AUTH
$config['redis_slave']['timeout'] = 0.25;

$config['redis_backup']['host'] = '10.160.29.137';
$config['redis_backup']['port'] = '6379';
$config['redis_backup']['password'] = 't3)TKle[q8vk\|&JsM1%!yj{(2:G0-HN';
