    ...
    $(this).click(function(){
        ...
        soundManager.createSound({
            ...
            whileplaying:function(){
                ...
                _this.next('.sm2_stop').addClass('sm2_covers').removeClass('sm2_undisI');
            },
            onfinish:function(){
                _this.removeClass('sm2_playing');
                _this.next('.sm2_stop').removeClass('sm2_covers').addClass('sm2_undisI');
            }
        });
    })
});
...
$('.sm2_stop').each(function(){
    $(this).click(function(){
        $(this).prev('.sm2_button').addClass('sm2_paused');
