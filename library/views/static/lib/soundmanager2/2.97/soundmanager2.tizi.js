(function(window, _undefined) {
    ...
    function SoundManager(smURL, smID) {
        ...
        this.canPlayLink = function(oLink) {
            ...
            return sm2.canPlayURL(oLink.getAttribute('url'));
        };
...
function BasicMP3Player() {
  ...
  this.events = {
    ...
    finish: function() {
      ...
      if (pl.config.playNext) {
        var nextLink = (pl.indexByURL[this._data.oLink.getAttribute('url')]+1);
  ...
  this.handleClick = function(e) {
    ...
    var o = self.getTheDamnLink(e),
        ...
        soundURL,
        thisSound;
    if (o.nodeName.toLowerCase() !== 'em') {
      o = self.isChildOfNode(o,'em');
      if (!o) {
        return true;
      }
    }
  ...
  this.init = function() {
    ...
    var i, j,
        foundItems = 0,
        oLinks = document.getElementsByTagName('em');
    // grab all links, look for .mp3
    for (i=0, j=oLinks.length; i<j; i++) {
      if (self.classContains(oLinks[i],self.css.sDefault) && !self.classContains(oLinks[i],self.excludeClass)) {
        // self.addClass(oLinks[i],self.css.sDefault); // add default CSS decoration - good if you're lazy and want ALL MP3/playable links to do this
        self.links[foundItems] = (oLinks[i]);
        self.indexByURL[oLinks[i].getAttribute('url')] = foundItems; // hack for indexing
        foundItems++;
      }
    }
    if (foundItems>0) {
