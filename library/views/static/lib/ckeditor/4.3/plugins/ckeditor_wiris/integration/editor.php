...
<html>
	<head>
		...
		?>
		<script type="text/javascript" src="<?php echo '../core/editor_base.js?lang=' . rawurlencode($config['wirisformulaeditorlang']); ?>"></script>
	...
	<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
		<div id="container">
			...
			<div id="links">
				<a href="#" target="_blank" id="a_latex" style="display:none;" >LaTeX</a> 
				<a href="#" target="_blank" id="a_manual" style="display:none;" >Manual</a>
			</div>
		</div>
	</body>
</html>