...
class com_wiris_plugin_PluginAPI {
	...
	public function mathml2img($mathml, $baseURL, $properties = array(),$oldurl = '') {
		...
		$toSave = str_replace('mml=','',$toSave);
		$config = wrs_loadConfig(WRS_CONFIG_FILE);
		$url =make_img_Curl($config['makeimgserver'],array('mml'=>$toSave,'oldsrc'=>$oldurl),$referer);
		return $url;
	}
