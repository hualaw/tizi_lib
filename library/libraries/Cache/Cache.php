...
class CI_Cache extends CI_Driver_Library {
	...
	protected $valid_drivers 	= array(
		'cache_apc', 'cache_file', 'cache_memcached', 'cache_dummy', 'cache_redis', 'cache_redisgbt'
	);
	 ...
	 * __call magic method
	 *
	 * Handles access to the adapter's methods
	 *
	 * @access	public
	 * @param	string
	 * @param	array
	...
	{
		if (method_exists($this->{$this->_adapter}, $method))
		{
