...
class Teacher_Data_Model extends Data_Model {
    ...
    public function update_student_football($user_id,$gender,$school_id,$teacher_name)
    {
        if(!$gender||!$school_id||!$teacher_name) return false;
        return $this->update_data_array($user_id,array('sex'=>$gender,'school_id'=>$school_id,'teacher_name'=>$teacher_name));
    }
