...
class Student_Zuoye_Model extends MY_Model {
    ...
    public function get($where){
        ...
        $this->db->select('zuoye_student.*, zuoye_assign.video_ids, zuoye_assign.user_id as teacher_id, zuoye_assign.unit_game_ids,zuoye_assign.start_time,zuoye_assign.end_time, zuoye_comment.content');
